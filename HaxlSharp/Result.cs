...
namespace HaxlSharp
{
    ...
    public class Blocked : Result
    {
        ...
        public readonly HaxlFetch Continue;

        public static Blocked New(IEnumerable<BlockedRequest> blocked, HaxlFetch cont)
        {
            return new Blocked(blocked, cont);
        }

        private Blocked(IEnumerable<BlockedRequest> blocked, HaxlFetch cont)
        {
